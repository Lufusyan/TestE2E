...
public class TestCDRCallerNumber2More {
    private BufferedWriter writer;

    public void generateCDRFiles() {
        try {
            String fileName = "TestCDRCallerNumber2More";
    ...
    private void generateCDR() throws IOException {
        ...
        long calleeNumber = 80000000000L;
    ...
    public static void main(String[] args) {
        TestCDRCallerNumber2More generator = new TestCDRCallerNumber2More();
